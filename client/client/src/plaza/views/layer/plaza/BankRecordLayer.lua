...
function BankRecordLayer:ctor(scene)
    ...
    display.newSprite("BankRecord/title_bankrecord.png")
		:move(yl.WIDTH/2,yl.HEIGHT - 70)
		:addTo(self)
	display.newSprite("BankRecord/frame_back_2.png")
		:move(yl.WIDTH/2,326)
		:addTo(self)

	ccui.Button:create("BankRecord/bt_return_0.png","BankRecord/bt_return_1.png")
    ...
    self._listView = cc.TableView:create(cc.size(1161, 420))
...
function BankRecordLayer.tableCellAtIndex(view, idx)		
	...
	cc.Label:createWithTTF(date,"fonts/round_body.ttf",18)
		:move(160,height/2)
		:setVerticalAlignment(cc.VERTICAL_TEXT_ALIGNMENT_CENTER)
		:setTextColor(cc.c4b(73,53,0,255))
		:setAnchorPoint(cc.p(0.5,0.5))
		:addTo(cell)
